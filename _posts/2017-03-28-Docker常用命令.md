...
* docker run # 创建并启动一个容器
	...
	- `docker run --name rmqconsole --link rmqnamesrv:rmqnamesrv -e "JAVA_OPTS=-Drocketmq.namesrv.addr=rmqnamesrv:9876 -Dcom.rocketmq.sendMessageWithVIPChannel=false" -p 8123:8080 -t styletang/rocketmq-console-ng`
