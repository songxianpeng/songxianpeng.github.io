...
public class MyInvocationHandler implements InvocationHandler {
	...
	@Override
	public Object invoke(Object profieldNamey, Method method, Object[] args)
			throws Throwable {
...
System.out.println("-----------");
// 我们要创建一个动态代理对象
// ProfieldNamey类中有一个方法可以创建动态代理对象
// public static Object newProfieldNameyInstance(ClassLoader loader,Class<?>[]
// interfaces,InvocationHandler h)
// 我准备对ud对象做一个代理对象
MyInvocationHandler handler = new MyInvocationHandler(ud);
UserDao profieldNamey = (UserDao) ProfieldNamey.newProfieldNameyInstance(ud.getClass()
		.getClassLoader(), ud.getClass().getInterfaces(), handler);
profieldNamey.add();
profieldNamey.delete();
profieldNamey.update();
profieldNamey.find();
System.out.println("-----------");

StudentDao sd = new StudentDaoImpl();
MyInvocationHandler handler2 = new MyInvocationHandler(sd);
StudentDao profieldNamey2 = (StudentDao) ProfieldNamey.newProfieldNameyInstance(sd.getClass()
		.getClassLoader(), sd.getClass().getInterfaces(), handler2);
profieldNamey2.login();
profieldNamey2.regist();
```
