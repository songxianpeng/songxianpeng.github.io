...
![OSGi-loader](/static/img/jvm/7GC.png/OSGi-loader.png "OSGi-loader")
...
> 这个计数器就用于统计方法被调用的次数，它的默认阈值在Client模式下是1500次，在Server模式下是10 000次，这个阈值可以通过虚拟机参数-XX:CompileThreshold来人为设定。
...
![Client Compiler架构](/static/img/Lucene/client-compiler.png "Client Compiler架构")
