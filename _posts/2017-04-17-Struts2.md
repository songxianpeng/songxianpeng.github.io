...
<%--单选--%>
<s:radio name="sex" label="sex" list="{'male','female'}"/>
<s:radio name="sex" label="sex" list="#{'M':'male','F':'female'}"/>
<%--多选--%>
<s:checkboxlist name="hobby" label="hobby" list="{'basketball','ping-pong'}"/>
<s:checkboxlist name="hobby" label="hobby" list="#{'B':'basketball','P':'ping-pong'}"/>
<%--下拉框--%>
<s:select name="job" label="job" list="#{'T':'teacher','W':'worker'}"/>
<%--文件上传--%>
<s:file label="upload"/>
<%--hidden--%>
