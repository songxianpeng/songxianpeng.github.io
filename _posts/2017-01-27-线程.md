...
![LeftRightDeadLock](/static/线程/LeftRightDeadLock.png "LeftRightDeadLock")
...
![amdahl-speedup](/static/线程/amdahl-speedup.jpg "amdahl-speedup")

在串行部分所占不同比例下的最高利用率：

![Maximum-utilization-at-different-proportions-of-the-serial-section](/static/线程/Maximum-utilization-at-different-proportions-of-the-serial-section.png "Maximum-utilization-at-different-proportions-of-the-serial-section")
...
![Different-queue-throughput](/static/线程/Different-queue-throughput.png "Different-queue-throughput")
...
![Comparison-of-scalability-of-different-Map-implementations](/static/线程/Comparison-of-scalability-of-different-Map-implementations.png "Comparison-of-scalability-of-different-Map-implementations")
...
* 解决方案可以扩展到多个生产者：只需每个生产者都想队列放入一个”毒丸“对象，并且消费者仅当在接收到N个生产者的”毒丸“对象时才停止。
...
![Performance-comparison-between-fair-lock-and-non-fair-lock](/static/线程/Performance-comparison-between-fair-lock-and-non-fair-lock.png "Performance-comparison-between-fair-lock-and-non-fair-lock")
...
![read-write-lock-performence.png](/static/线程/read-write-lock-performence.png "read-write-lock-performence.png")
...
![sleep-and-retry.png](/static/线程/sleep-and-retry.png "sleep-and-retry.png")
...
![Lock-and-AtomicInteger-performance-in-a-highly-competitive-situation](/static/线程/Lock-and-AtomicInteger-performance-in-a-highly-competitive-situation.png "Lock-and-AtomicInteger-performance-in-a-highly-competitive-situation")

在竞争程度适中情况下的Lock与AtomicInteger的性能：

![Lock-and-AtomicInteger-performance-in-moderately-competitive-situations](/static/线程/Lock-and-AtomicInteger-performance-in-moderately-competitive-situations.png "Lock-and-AtomicInteger-performance-in-moderately-competitive-situations")
...
![The-normal-state-of-the-queue-containing-two-elements](/static/线程/The-normal-state-of-the-queue-containing-two-elements.png "The-normal-state-of-the-queue-containing-two-elements")
...
![Opposition-in-the-middle-of-the-insertion-process](/static/线程/Opposition-in-the-middle-of-the-insertion-process.png "Opposition-in-the-middle-of-the-insertion-process")

在插入操作完成后，队列再次处于稳定状态：

![After-the-insertion-is-complete-the-queue-returns-to-steady-state-again](/static/线程/After-the-insertion-is-complete-the-queue-returns-to-steady-state-again.png "After-the-insertion-is-complete-the-queue-returns-to-steady-state-again")
...
![Compare-different-blocking-queue-implementations](/static/线程/Compare-different-blocking-queue-implementations.png "Compare-different-blocking-queue-implementations")
...
![Multi-cache](/static/线程/Multi-cache.png "Multi-cache")

单元素缓存：

![Single-element-cache](/static/线程/Single-element-cache.png"Single-element-cache")
...
![Explain-the-happens-before-relationship-in-the-java-memory-model](/static/线程/Explain-the-happens-before-relationship-in-the-java-memory-model.png "Explain-the-happens-before-relationship-in-the-java-memory-model")
